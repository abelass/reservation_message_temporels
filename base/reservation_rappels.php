...
function reservation_rappels_declarer_tables_objets_sql($tables) {
	...
	$tables['spip_reservation_rappels'] = array(
		...
		'date' => 'date',
		'champs_editables'  => array('titre', 'descriptif', 'rappel_precedent', 'frequence_cron', 'declencheur_date', 'declencheur_statut', 'nombre_jours'),
		'champs_versionnes' => array('titre', 'descriptif', 'rappel_precedent', 'frequence_cron', 'declencheur_date', 'declencheur_statut', 'nombre_jours'),
